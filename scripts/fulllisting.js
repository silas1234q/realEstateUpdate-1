import { newFullListingArr } from "./main.js";
...
let fullListings ='';
console.log(newFullListingArr);

newFullListingArr.forEach(item=>{
...
document.querySelector('.house-info-container').innerHTML = fullListings;